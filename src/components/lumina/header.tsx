            ...
            <div className="flex items-center gap-6">
                ...
                <div className="flex items-center gap-3 group cursor-pointer">
                    <div className="text-right hidden md:block">
                        <p className="text-sm font-medium text-white group-hover:text-purple-400 transition-colors">{tenantName}</p>
                        <p className="text-xs text-gray-500">Administrador</p>
                    </div>
                    <div className="h-10 w-10 rounded-full bg-gradient-to-tr from-purple-500 to-indigo-500 border-2 border-[#1c1c1c] shadow-lg group-hover:scale-105 transition-transform" />
                </div>
            </div>
        </header>
    );
